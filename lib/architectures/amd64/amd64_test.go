...
func TestGadgetDecoder(t *testing.T) {
	...
	expectedStr := "MOV ECX, [RBP+0xffffff48]; MOV RAX, [RIP+0x1181]; MOV RAX, [RAX]; CMP RAX, [RBP-0x30]; JNE .+20; " +
		"MOV EAX, ECX; ADD RSP, 0x98; POP RBX; POP R12; POP R13; POP R14; POP R15; POP RBP; RET"
